...
SELECT ROWNUM AS NRO_REG,
       ...
       (SELECT
        ...
        AND DET.ID_MULTA = MULT.ID_MULTA)   AS NRO_RESOL_OR, --num_resolu
       (SELECT
       ...
       scob_pk_utilitario.scob_fn_dias_laborables_neg(to_char((SELECT
              DET.FEC_RESOLUCION
         FROM T_SCOB_MULTA_DETAL DET
        INNER JOIN T_SCOB_ORGANO_RESOLUTIVO ORGA
           ON ORGA.ID_ORGANO_RESOLUTIVO = MDET.ID_ORGANO_RESOLUTIVO
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 1
        AND DET.ID_MULTA = MULT.ID_MULTA), 'DD/MM/YYYY'), to_char((SELECT
              TO_DATE(TO_CHAR(DET.AUDFECCREACION, 'DD/MM/YYYY'),
                      'DD/MM/YYYY')
         FROM T_SCOB_MULTA_DETAL DET
        INNER JOIN T_SCOB_ORGANO_RESOLUTIVO ORGA
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 1
        AND DET.ID_MULTA = MULT.ID_MULTA),'DD/MM/YYYY')) AS CANTIDAD_OR,
       --SEGUNDA INSTANCIA
       (SELECT
              DET.NRO_RESOLUCION
         FROM T_SCOB_MULTA_DETAL DET
        ...
        AND DET.ID_MULTA = MULT.ID_MULTA)              AS NRO_RESOL_COMISION,
       (SELECT
              TO_DATE(TO_CHAR(DET.AUDFECCREACION, 'DD/MM/YYYY'),
                      'DD/MM/YYYY')
         FROM T_SCOB_MULTA_DETAL DET
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 2
        AND DET.ID_MULTA = MULT.ID_MULTA)                AS FEC_REG_COMISION,
       (SELECT
              DET.FEC_RESOLUCION
         FROM T_SCOB_MULTA_DETAL DET
        INNER JOIN T_SCOB_ORGANO_RESOLUTIVO ORGA
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 2
        AND DET.ID_MULTA = MULT.ID_MULTA)              AS FEC_RESOL_COMISION,
       (SELECT
              DET.FEC_NOTIFICACION_RESOLUCION
         FROM T_SCOB_MULTA_DETAL DET
        INNER JOIN T_SCOB_ORGANO_RESOLUTIVO ORGA
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 2
        AND DET.ID_MULTA = MULT.ID_MULTA) AS FEC_NOTIF_RESOL_COMISION,
       (SELECT
              DET.FEC_ESTADO_SGTE_INSTANCIA
         FROM T_SCOB_MULTA_DETAL DET
        INNER JOIN T_SCOB_ORGANO_RESOLUTIVO ORGA
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 2
        AND DET.ID_MULTA = MULT.ID_MULTA)   AS FEC_REVISION,
       (SELECT
              DET.AUDUSUCREACION
         FROM T_SCOB_MULTA_DETAL DET
        INNER JOIN T_SCOB_ORGANO_RESOLUTIVO ORGA
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 2
        AND DET.ID_MULTA = MULT.ID_MULTA)      AS USU_REG_COMISION,
       ...
       scob_pk_utilitario.scob_fn_dias_laborables_neg(to_char((SELECT
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 2
        AND DET.ID_MULTA = MULT.ID_MULTA),'DD/MM/YYYY'),
                                                      to_char((SELECT
              TO_DATE(TO_CHAR(DET.AUDFECCREACION, 'DD/MM/YYYY'),
                      'DD/MM/YYYY')
         FROM T_SCOB_MULTA_DETAL DET
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 2
        AND DET.ID_MULTA = MULT.ID_MULTA),'DD/MM/YYYY')) AS CANTIDAD_COMISION,
       --TERCERA INSTANCIA
       (SELECT
              DET.NRO_RESOLUCION
         FROM T_SCOB_MULTA_DETAL DET
        ...
        AND DET.ID_MULTA = MULT.ID_MULTA)              AS NRO_RESOL_SALA,
       (SELECT
              TO_DATE(TO_CHAR(DET.AUDFECCREACION, 'DD/MM/YYYY'),
                      'DD/MM/YYYY')
         FROM T_SCOB_MULTA_DETAL DET
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 3
        AND DET.ID_MULTA = MULT.ID_MULTA)                AS FEC_REG_SALA,
       (SELECT
              DET.FEC_RESOLUCION
         FROM T_SCOB_MULTA_DETAL DET
        INNER JOIN T_SCOB_ORGANO_RESOLUTIVO ORGA
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 3
        AND DET.ID_MULTA = MULT.ID_MULTA)              AS FEC_RESOL_SALA,
       (SELECT
              DET.FEC_NOTIFICACION_RESOLUCION
         FROM T_SCOB_MULTA_DETAL DET
        INNER JOIN T_SCOB_ORGANO_RESOLUTIVO ORGA
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 3
        AND DET.ID_MULTA = MULT.ID_MULTA) AS FEC_NOTIF_RESOL_SALA,
       (SELECT
              DET.AUDUSUCREACION
         FROM T_SCOB_MULTA_DETAL DET
        INNER JOIN T_SCOB_ORGANO_RESOLUTIVO ORGA
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 3
        AND DET.ID_MULTA = MULT.ID_MULTA)      AS USU_REG_SALA,
       ...
       scob_pk_utilitario.scob_fn_dias_laborables_neg(to_char((SELECT
        ...
        WHERE DET.ESTADO = '1'
        AND ORGA.TIPO_INSTANCIA = 3
        AND DET.ID_MULTA = MULT.ID_MULTA),'DD/MM/YYYY')) AS CANTIDAD_SALA,
       ------------------------------------------------------
