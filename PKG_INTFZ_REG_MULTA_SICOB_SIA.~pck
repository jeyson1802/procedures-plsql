CREATE OR REPLACE PACKAGE PKG_INTFZ_REG_MULTA_SICOB_SIA IS
 ...
 PROCEDURE SP_I_ARCH_CENTRAL_SICOB_A_SIA(PIN_NU_ID_MULTA    IN NUMBER,
  ...
  PROCEDURE SP_D_MULTA_SICOB_A_SIA(PIN_NU_ID_MULTA      IN NUMBER,
                                   POUT_NU_COD_RESULT   OUT NUMBER,
                                   POUT_VC_MSG_RESULT   OUT VARCHAR2);
                                   
  PROCEDURE SP_U_EXPEDIENTE_CERO_A_SIA(PIN_NU_ID_MULTA   IN NUMBER,
                                     POUT_NU_COD_RESULT OUT NUMBER,
                                     POUT_VC_MSG_RESULT OUT VARCHAR2);
 
  PROCEDURE SP_U_EXPEDIENTE_SICOB_A_SIA(PIN_NU_ID_MULTA   IN NUMBER,
                                        POUT_NU_COD_RESULT OUT NUMBER,
                                        POUT_VC_MSG_RESULT OUT VARCHAR2);                                                                   
END;
/
...
/*****************************************************************
'* Nombre           :  SP_I_MULTA_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Procedure que registra la multa en SIA
'*                     
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  Victor Bendezú
'* Fec Creación     :  10/12/2022  18:06:00
'* Fec Actualización:  
'****************************************************************/
  PROCEDURE SP_I_MULTA_SICOB_A_SIA(PIN_NU_ID_MULTA   IN NUMBER,
                                   POUT_NU_COD_RESULT OUT NUMBER,
    ...
    V_REG_T_SCOB_TIPO_PROCEDIMTO       USR_SICOB.T_SCOB_TIPO_PROCEDIMIENTO%ROWTYPE;
    ...
    V_DT_FECHAREGISTRO                 SGCORESYS.CO_MULTA.FECHAREGISTRO%TYPE;
    ...
    V_DT_ORPSRESOLFECHAREGISTRO        SGCORESYS.CO_MULTA.ORPSRESOLFECHAREGISTRO%TYPE;
    V_DT_ORPSRESOLFECHAEMISION         SGCORESYS.CO_MULTA.ORPSRESOLFECHAEMISION%TYPE;
    V_DT_ORPSRESOLFECNOTIFICA          SGCORESYS.CO_MULTA.ORPSRESOLFECHANOTIFICACION%TYPE;
    V_DT_ORPSFECHAAPELACION            SGCORESYS.CO_MULTA.ORPSFECHAAPELACION%TYPE;
    ...
    V_DT_COMRESOLFECHAREGISTRO         SGCORESYS.CO_MULTA.COMRESOLFECHAREGISTRO%TYPE;
    V_DT_COMRESOLFECHAEMISION          SGCORESYS.CO_MULTA.COMRESOLFECHAEMISION%TYPE;
    V_DT_COMRESOLFECHANOTIFICACION     SGCORESYS.CO_MULTA.COMRESOLFECHANOTIFICACION%TYPE;
    V_DT_COMFECHAREVISION              SGCORESYS.CO_MULTA.COMFECHAREVISION%TYPE;
    ...
    V_DT_SALARESOLFECHAREGISTRO        SGCORESYS.CO_MULTA.SALARESOLFECHAREGISTRO%TYPE;
    V_DT_SALARESOLFECHAEMISION         SGCORESYS.CO_MULTA.SALARESOLFECHAEMISION%TYPE;
    V_DT_SALARESOLFECNOTIFICA    SGCORESYS.CO_MULTA.SALARESOLFECHANOTIFICACION%TYPE;
    ...
    V_DT_SECFECHAREGISTRO              SGCORESYS.CO_MULTA.SECFECHAREGISTRO%TYPE;
    V_VC_FILEANIO                      SGCORESYS.CO_MULTA.FILEANIO%TYPE;
    V_DT_FILEFECHARECEPCION            SGCORESYS.CO_MULTA.FILEFECHARECEPCION%TYPE;
    ...
    V_DT_FECHAOBSERVACION              SGCORESYS.CO_MULTA.FECHAOBSERVACION%TYPE;
    V_DT_FECHAULTIMOINGRESO            SGCORESYS.CO_MULTA.FECHAULTIMOINGRESO%TYPE;
    V_VC_COBEXPEDIENTENRO              SGCORESYS.CO_MULTA.COBEXPEDIENTENRO%TYPE;
    V_DT_COBEXPEDIENTEFECHA            SGCORESYS.CO_MULTA.COBEXPEDIENTEFECHA%TYPE;
    V_VC_COBGESTOR                     SGCORESYS.CO_MULTA.COBGESTOR%TYPE;
    V_DT_FECHAASIGNACION               SGCORESYS.CO_MULTA.FECHAASIGNACION%TYPE;
    V_DT_FECHACARTA                    SGCORESYS.CO_MULTA.FECHACARTA%TYPE;
    V_DT_RECFECHAEMISION               SGCORESYS.CO_MULTA.RECFECHAEMISION%TYPE;
    V_DT_RECFECHANOTIFICACION          SGCORESYS.CO_MULTA.RECFECHANOTIFICACION%TYPE;
    ...
    V_DT_COBFECHAULTIMO                SGCORESYS.CO_MULTA.COBFECHAULTIMO%TYPE;
    V_DT_FECHARIESGO                   SGCORESYS.CO_MULTA.FECHARIESGO%TYPE;
    ...
    V_DT_ENVIOFECHA                    SGCORESYS.CO_MULTA.ENVIOFECHA%TYPE;
    V_VC_UBICACIONFISICA               SGCORESYS.CO_MULTA.UBICACIONFISICA%TYPE;
    V_NU_CUOTA                         SGCORESYS.CO_MULTA.CUOTA%TYPE;
    V_DT_FECHAVENCIMIENTO              SGCORESYS.CO_MULTA.FECHAVENCIMIENTO%TYPE;
    ...
    V_DT_AECNOTIFICACIONFECHA          SGCORESYS.CO_MULTA.AECNOTIFICACIONFECHA%TYPE;
    ...
    V_DT_CUOTANOTIFICACIONFECHA        SGCORESYS.CO_MULTA.CUOTANOTIFICACIONFECHA%TYPE;
    ...
    V_DT_COBRANZADUDOSAFECHA           SGCORESYS.CO_MULTA.COBRANZADUDOSAFECHA%TYPE;
    V_VC_COBRADUDOSAVOUCHECLEAR        SGCORESYS.CO_MULTA.COBRANZADUDOSAVOUCHERCLEARING%TYPE;
    V_DT_COBRADUDOSAFECCLEAR           SGCORESYS.CO_MULTA.COBRANZADUDOSAFECHACLEARING%TYPE;
    V_VC_AECCONCILIACIONESTADO         SGCORESYS.CO_MULTA.AECCONCILIACIONESTADO%TYPE;
    V_DT_AECCONCILIACIONFECHA          SGCORESYS.CO_MULTA.AECCONCILIACIONFECHA%TYPE;
    ...
    V_DT_CASTIGORESOLFECHA             SGCORESYS.CO_MULTA.CASTIGORESOLFECHA%TYPE;
    V_DT_CUOTAFINRESOLFECHA            SGCORESYS.CO_MULTA.CUOTAFINRESOLFECHA%TYPE;
    V_DT_CUOTAFINRESOLNUMERO           SGCORESYS.CO_MULTA.CUOTAFINRESOLNUMERO%TYPE;
    ...
    V_DT_DECLFECHAEMISION01            SGCORESYS.CO_MULTA.DECLFECHAEMISION01%TYPE;
    V_DT_DECLFECHANOTIF01              SGCORESYS.CO_MULTA.DECLFECHANOTIF01%TYPE;
    V_VC_DECLNUMERO02                  SGCORESYS.CO_MULTA.DECLNUMERO02%TYPE;
    V_DT_DECLFECHAEMISION02            SGCORESYS.CO_MULTA.DECLFECHAEMISION02%TYPE;
    V_DT_DECLFECHANOTIF02              SGCORESYS.CO_MULTA.DECLFECHANOTIF02%TYPE;
    V_VC_DECLNUMERO03                  SGCORESYS.CO_MULTA.DECLNUMERO03%TYPE;
    V_DT_DECLFECHAEMISION03            SGCORESYS.CO_MULTA.DECLFECHAEMISION03%TYPE;
    V_DT_DECLFECHANOTIF03              SGCORESYS.CO_MULTA.DECLFECHANOTIF03%TYPE;
    ...
    V_NU_MONTOPROVIDUDOSAGASTO         SGCORESYS.CO_MULTA.MONTOPROVISIONDUDOSAGASTOS%TYPE;
    V_NU_MONTOVOUCHERCOBRANZA          SGCORESYS.CO_MULTA.MONTOVOUCHERCOBRANZA%TYPE;
    V_NU_MONTOVOUCHERCOBRAGASTO        SGCORESYS.CO_MULTA.MONTOVOUCHERCOBRANZAGASTOS%TYPE;
    ...
    V_DT_ME_FECHA                         SGCORESYS.CO_MULTAESTADO.FECHA%TYPE;
    V_VC_ME_CONTAPENDIENTEFLAG            SGCORESYS.CO_MULTAESTADO.CONTABILIZACIONPENDIENTEFLAG%TYPE;
    ...
    V_DT_ME_ULTIMAFECHAMODIF              SGCORESYS.CO_MULTAESTADO.ULTIMAFECHAMODIF%TYPE;
    ...
    V_DT_ME_ORCONCILIACIONFECHA           SGCORESYS.CO_MULTAESTADO.ORCONCILIACIONFECHA%TYPE;
  ...
  BEGIN
    ...
    BEGIN
      ...
      SELECT PROC.*
        INTO V_REG_T_SCOB_TIPO_PROCEDIMTO
    ...
    V_DT_FECHAREGISTRO := V_REG_T_SCOB_MULTA.FEC_INGRESO;
    V_VC_CODTIPOPROCEDIMIENTO := V_REG_T_SCOB_TIPO_PROCEDIMTO.CODIGO;
    ...
    IF V_REG_T_SCOB_ORGANO_RESOLUTIVO.TIPO_INSTANCIA = 1 THEN
      ...
      V_DT_ORPSRESOLFECHAREGISTRO := TRUNC(V_REG_T_SCOB_MULTA_DETAL.AUDFECCREACION);
      V_DT_ORPSRESOLFECHAEMISION := V_REG_T_SCOB_MULTA_DETAL.FEC_RESOLUCION;
      V_DT_ORPSRESOLFECNOTIFICA := V_REG_T_SCOB_MULTA_DETAL.FEC_NOTIFICACION_RESOLUCION;
      V_DT_ORPSFECHAAPELACION := V_REG_T_SCOB_MULTA_DETAL.FEC_ESTADO_SGTE_INSTANCIA;
    ...
    IF V_REG_T_SCOB_ORGANO_RESOLUTIVO.TIPO_INSTANCIA = 2 THEN
      ...
      V_DT_COMRESOLFECHAREGISTRO := TRUNC(V_REG_T_SCOB_MULTA_DETAL.AUDFECCREACION);
      V_DT_COMRESOLFECHAEMISION := V_REG_T_SCOB_MULTA_DETAL.FEC_RESOLUCION;
      V_DT_COMRESOLFECHANOTIFICACION := V_REG_T_SCOB_MULTA_DETAL.FEC_NOTIFICACION_RESOLUCION;
      V_DT_COMFECHAREVISION := V_REG_T_SCOB_MULTA_DETAL.FEC_ESTADO_SGTE_INSTANCIA;
    ...
    IF V_REG_T_SCOB_ORGANO_RESOLUTIVO.TIPO_INSTANCIA = 3 THEN
      ...
      V_DT_SALARESOLFECHAREGISTRO := TRUNC(V_REG_T_SCOB_MULTA_DETAL.AUDFECCREACION);
      V_DT_SALARESOLFECHAEMISION := V_REG_T_SCOB_MULTA_DETAL.FEC_RESOLUCION;
      V_DT_SALARESOLFECNOTIFICA := V_REG_T_SCOB_MULTA_DETAL.FEC_NOTIFICACION_RESOLUCION;
    ...
    V_DT_SECFECHAREGISTRO := V_REG_T_SCOB_MULTA.FEC_GENERACION_SEC;
    V_VC_FILEANIO := V_REG_T_SCOB_MULTA.ANIO_FILE_AEC;
    V_DT_FILEFECHARECEPCION := V_REG_T_SCOB_MULTA.FEC_INGRESO_AEC;   
    V_VC_ESTADOMULTACOBRANZA := V_REG_T_SCOB_MULTA_DETAL.ESTADO_MULTA;
    V_DT_FECHAOBSERVACION := V_REG_T_SCOB_MULTA.FEC_ULT_IMPROCEDENCIA;
    V_DT_FECHAULTIMOINGRESO := V_REG_T_SCOB_MULTA.FEC_INGRESO_FILE;
    V_DT_FECHAASIGNACION := V_REG_T_SCOB_MULTA.FECHA_ASIG_COBRANZA;
    V_DT_FECHACARTA := V_REG_T_SCOB_MULTA.FEC_ULT_GEN_PRECOACTIVA;
    V_DT_RECFECHAEMISION := V_REG_T_SCOB_MULTA.FEC_EMISION_REC;
    V_DT_RECFECHANOTIFICACION := V_REG_T_SCOB_MULTA.FEC_NOTIF_REC;
    V_DT_FECHARIESGO := SYSDATE;
    ...
    IF V_REG_T_SCOB_MULTA.COD_MOTIVO = 0 THEN
      V_VC_CODMOTIVOMULTA:=NULL; --VV_EMBARGOFLAG := NULL;
    ELSE 
      V_VC_CODMOTIVOMULTA:= V_REG_T_SCOB_MULTA.COD_MOTIVO; --VV_EMBARGOFLAG := REG_T_SCOB_MULTA.COD_MOTIVO;
    END IF;
    ...
    (
      ...
      V_DT_ORPSRESOLFECHAREGISTRO,
      V_DT_ORPSRESOLFECHAEMISION,
      V_DT_ORPSRESOLFECNOTIFICA,
      V_DT_ORPSFECHAAPELACION,
      V_VC_ORPSUSUARIO,
      V_NU_ORPSCANTIDADDIAS,
      V_VC_COMRESOLNUMERO,
      V_DT_COMRESOLFECHAREGISTRO,
      V_DT_COMRESOLFECHAEMISION,
      V_DT_COMRESOLFECHANOTIFICACION,
      V_DT_COMFECHAREVISION,
      V_VC_COMUSUARIO,
      V_NU_COMCANTIDADDIAS,
      V_VC_SALARESOLNUMERO,
      V_DT_SALARESOLFECHAREGISTRO,
      V_DT_SALARESOLFECHAEMISION,
      V_DT_SALARESOLFECNOTIFICA,
      V_VC_SALAUSUARIO,
      ...
      V_VC_ESTADOMULTA,
      V_NU_DESCUENTOMULTA,
      V_DT_SECFECHAREGISTRO,
      V_VC_FILEANIO,
      V_DT_FILEFECHARECEPCION,
      V_VC_FILENUMERO,
      V_VC_NUMEROINGRESO,
      V_VC_ESTADOMULTACOBRANZA,
      V_VC_CODMOTIVOMULTA,
      V_DT_FECHAOBSERVACION,
      V_DT_FECHAULTIMOINGRESO,
      V_VC_COBEXPEDIENTENRO,
      V_DT_COBEXPEDIENTEFECHA,
      V_VC_COBGESTOR,
      V_DT_FECHAASIGNACION,
      V_DT_FECHACARTA,
      V_DT_RECFECHAEMISION,
      V_DT_RECFECHANOTIFICACION,
      ...
      V_VC_CODCENTROCOSTO,
      V_VC_DECLNUMERO01,
      V_DT_DECLFECHAEMISION01,
      V_DT_DECLFECHANOTIF01,
      V_VC_DECLNUMERO02,
      V_DT_DECLFECHAEMISION02,
      V_DT_DECLFECHANOTIF02,
      V_VC_DECLNUMERO03,
      V_DT_DECLFECHAEMISION03,
      V_DT_DECLFECHANOTIF03,
      V_NU_SALDOCAPITAL,
      V_NU_SALDOINTERES,
      V_NU_MONTOPROVISIONDUDOSA,
      V_NU_MONTOPROVIDUDOSAGASTO,
      V_NU_MONTOVOUCHERCOBRANZA,
      V_NU_MONTOVOUCHERCOBRAGASTO
    );
    ...
    INSERT INTO SGCORESYS.CO_MULTAESTADO(
      ...
      V_DT_ME_FECHA,
      V_VC_ME_CONTAPENDIENTEFLAG,
      V_VC_ME_PERIODO,
      V_VC_ME_VOUCHER,
      V_VC_ME_ULTIMOUSUARIO,
      V_DT_ME_ULTIMAFECHAMODIF,
      V_VC_ME_CODIGOMULTA,
      V_VC_ME_ORCONCILIACIONESTADO,
      V_DT_ME_ORCONCILIACIONFECHA,
      V_VC_ME_CODAREA,
      V_NU_ME_UITNRO,
...
/*****************************************************************
'* Nombre           :  SP_U_MULTA_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Procedure que actualiza la multa en SIA
'*                     
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  Victor Bendezú
...
'****************************************************************/
  ...
  BEGIN
    ...
    --DBMS_OUTPUT.PUT_LINE('SP_ACTUALIZA_MULTA_SICOB_A_SIA>>VV_EXPEDIENTE>>' || VV_EXPEDIENTE);
    --TIPO_INSTANCIA DEL ÓRGANO RESOLUTIVO = 1
    IF V_REG_T_SCOB_ORGANO_RESOLUTIVO.TIPO_INSTANCIA = 1 THEN
      V_VC_ORPSRESOLNUMERO := V_REG_T_SCOB_MULTA_DETAL.NRO_RESOLUCION;
      V_DT_ORPSRESOLFECHAREGISTRO := TRUNC(V_REG_T_SCOB_MULTA_DETAL.AUDFECCREACION);
    ...
    --DBMS_OUTPUT.PUT_LINE('SP_ACTUALIZA_MULTA_SICOB_A_SIA>>ESTADO_MULTA>>' || REG_T_SCOB_MULTA_DETAL.ESTADO_MULTA);    
     V_VC_ESTADOMULTACOBRANZA := V_REG_T_SCOB_MULTA_DETAL.ESTADO_MULTA;
    
    --DBMS_OUTPUT.PUT_LINE('SP_ACTUALIZA_MULTA_SICOB_A_SIA>>FEC_ULT_IMPROCEDENCIA>>' || REG_T_SCOB_MULTA.FEC_ULT_IMPROCEDENCIA);    
    V_DT_FECHAOBSERVACION := V_REG_T_SCOB_MULTA.FEC_ULT_IMPROCEDENCIA;
    
    --DBMS_OUTPUT.PUT_LINE('SP_ACTUALIZA_MULTA_SICOB_A_SIA>>FEC_INGRESO_FILE>>' || REG_T_SCOB_MULTA.FEC_INGRESO_FILE);    
    V_DT_FECHAULTIMOINGRESO := V_REG_T_SCOB_MULTA.FEC_INGRESO_FILE;
    
    --DBMS_OUTPUT.PUT_LINE('SP_ACTUALIZA_MULTA_SICOB_A_SIA>>FECHA_ASIG_COBRANZA>>' || REG_T_SCOB_MULTA.FECHA_ASIG_COBRANZA);    
     V_DT_FECHAASIGNACION := V_REG_T_SCOB_MULTA.FECHA_ASIG_COBRANZA;
    
    --DBMS_OUTPUT.PUT_LINE('SP_ACTUALIZA_MULTA_SICOB_A_SIA>>FEC_ULT_GEN_PRECOACTIVA>>' || REG_T_SCOB_MULTA.FEC_ULT_GEN_PRECOACTIVA);  
    V_DT_FECHACARTA := V_REG_T_SCOB_MULTA.FEC_ULT_GEN_PRECOACTIVA;
    
    --DBMS_OUTPUT.PUT_LINE('SP_ACTUALIZA_MULTA_SICOB_A_SIA>>FEC_EMISION_REC>>' || REG_T_SCOB_MULTA.FEC_EMISION_REC);  
    V_DT_RECFECHAEMISION := V_REG_T_SCOB_MULTA.FEC_EMISION_REC;

    
    --DBMS_OUTPUT.PUT_LINE('SP_ACTUALIZA_MULTA_SICOB_A_SIA>>FEC_NOTIF_REC>>' || REG_T_SCOB_MULTA.FEC_NOTIF_REC);  
    V_DT_RECFECHANOTIFICACION := V_REG_T_SCOB_MULTA.FEC_NOTIF_REC;
    
    V_DT_FECHARIESGO := SYSDATE;
    --DBMS_OUTPUT.PUT_LINE('SP_ACTUALIZA_MULTA_SICOB_A_SIA>>FLG_TIPO_MULTA>>' || REG_T_SCOB_MULTA.FLG_TIPO_MULTA);  
    V_VC_ESTADOPAGO := V_REG_T_SCOB_MULTA.FLG_TIPO_MULTA;
    
    --DBMS_OUTPUT.PUT_LINE('SP_ACTUALIZA_MULTA_SICOB_A_SIA>>DESCRIPCION>>' || REG_T_SCOB_ORGANO_RESOLUTIVO.DESCRIPCION);  
    V_VC_CODAREADESCRIPCION := V_REG_T_SCOB_ORGANO_RESOLUTIVO.DESCRIPCION;
    
    --DBMS_OUTPUT.PUT_LINE('SP_ACTUALIZA_MULTA_SICOB_A_SIA>>COD_MOTIVO>>' || REG_T_SCOB_MULTA.COD_MOTIVO);  
    IF V_REG_T_SCOB_MULTA.COD_MOTIVO = 0 THEN
      V_VC_CODMOTIVOMULTA:=NULL; --VV_EMBARGOFLAG := NULL;
    ELSE 
      V_VC_CODMOTIVOMULTA:= V_REG_T_SCOB_MULTA.COD_MOTIVO; --VV_EMBARGOFLAG := REG_T_SCOB_MULTA.COD_MOTIVO;
  ...
  UPDATE SGCORESYS.CO_MULTA SET 
      ANIO = V_VC_ANIO,
      ORIGEN = V_VC_ORIGEN,
      FECHAREGISTRO = V_DT_FECHAREGISTRO,
      ...
      ORPSRESOLFECHAREGISTRO = V_DT_ORPSRESOLFECHAREGISTRO,
      ORPSRESOLFECHAEMISION = V_DT_ORPSRESOLFECHAEMISION,
      ORPSRESOLFECHANOTIFICACION = V_DT_ORPSRESOLFECNOTIFICA,
      ORPSFECHAAPELACION = V_DT_ORPSFECHAAPELACION,
      ORPSUSUARIO = V_VC_ORPSUSUARIO,
      ORPSCANTIDADDIAS = V_NU_ORPSCANTIDADDIAS,
      COMRESOLNUMERO = V_VC_COMRESOLNUMERO,
      COMRESOLFECHAREGISTRO = V_DT_COMRESOLFECHAREGISTRO,
      COMRESOLFECHAEMISION = V_DT_COMRESOLFECHAEMISION,
      COMRESOLFECHANOTIFICACION = V_DT_COMRESOLFECHANOTIFICACION,
      COMFECHAREVISION = V_DT_COMFECHAREVISION,
      COMUSUARIO = V_VC_COMUSUARIO,
      COMCANTIDADDIAS = V_NU_COMCANTIDADDIAS,
      SALARESOLNUMERO = V_VC_SALARESOLNUMERO,
      SALARESOLFECHAREGISTRO = V_DT_SALARESOLFECHAREGISTRO,
      SALARESOLFECHAEMISION = V_DT_SALARESOLFECHAEMISION,
      SALARESOLFECHANOTIFICACION = V_DT_SALARESOLFECNOTIFICA,
      ...
      SECFECHAREGISTRO = V_DT_SECFECHAREGISTRO,
      FILEANIO = V_VC_FILEANIO,
      FILEFECHARECEPCION = V_DT_FILEFECHARECEPCION,
      ESTADOMULTACOBRANZA = V_VC_ESTADOMULTACOBRANZA,
      FECHAOBSERVACION = V_DT_FECHAOBSERVACION,
      FECHAULTIMOINGRESO = V_DT_FECHAULTIMOINGRESO,
      FECHAASIGNACION = V_DT_FECHAASIGNACION,
      FECHACARTA = V_DT_FECHACARTA,
      RECFECHAEMISION = V_DT_RECFECHAEMISION,
      RECFECHANOTIFICACION = V_DT_RECFECHANOTIFICACION,
      CODMOTIVOMULTA = V_VC_CODMOTIVOMULTA,      --EMBARGOFLAG = VV_EMBARGOFLAG,
      FECHARIESGO = V_DT_FECHARIESGO,
    ...
    ELSE
      ...
      UPDATE SGCORESYS.CO_MULTAESTADO SET 
        ...
        ULTIMAFECHAMODIF = V_DT_ME_ULTIMAFECHAMODIF,
...
/*****************************************************************
'* Nombre           :  SP_I_PERSONA_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Procedure que registra los denunciados y denunciantes en SIA
'*                     
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  Victor Bendezú
...
'****************************************************************/
  PROCEDURE SP_I_PERSONA_SICOB_A_SIA(PIN_NU_ID_MULTA    IN NUMBER,                            
    ...
    V_VC_DESCRIPCION_TIPO_DOC VARCHAR2(100);
  ...
  OPEN CURSOR_DENUNCIANTES(PIN_NU_ID_MULTA);
    ...
    OPEN CURSOR_SANCIONADOS(PIN_NU_ID_MULTA);
      ...
      LOOP 
        ...
        SELECT TDE.TXT_DESCRIPCION INTO V_VC_DESCRIPCION_TIPO_DOC
               FROM USR_SICOB.T_SCOB_TABLA_DET TDE 
               WHERE TDE.ID_TABLA = 10 AND TDE.COD_INTERNO = V_REG_T_SCOB_PERSONA.TIPO_DOC;
        
        SELECT SUBSTR(TRIM(DECODE(INSTR(V_VC_DESCRIPCION_TIPO_DOC, '/'), 0, V_VC_DESCRIPCION_TIPO_DOC, SUBSTR(V_VC_DESCRIPCION_TIPO_DOC, 1, INSTR(V_VC_DESCRIPCION_TIPO_DOC, '/') - 1))),1,1)
...
/*****************************************************************
'* Nombre           :  SP_I_RECEP_MULTA_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Procedure que recepciona la multa en SIA
'*                     
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  Victor Bendezú
...
/*****************************************************************
'* Nombre           :  SP_I_ASIGNAR_MULTA_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Procedure que asigna la multa en SIA
'*                     
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  Victor Bendezú
...
'****************************************************************/
  ...
  BEGIN
    ...
    V_VC_IDENTIFICADOR := V_REG_T_SCOB_MULTA.ANIO || V_REG_T_SCOB_MULTA.CUM;   
    DBMS_OUTPUT.put_line('V_VC_IDENTIFICADOR>>' || V_VC_IDENTIFICADOR);
               
    V_VC_ESTADOMULTA := V_REG_T_SCOB_MULTA_DETAL.ESTADO_MULTA;
    V_VC_COBGESTOR := V_REG_T_SCOB_USUARIO.USUARIO;
    V_DT_FECHAASIGNACION := V_REG_T_SCOB_MULTA.FECHA_ASIG_COBRANZA;
    DBMS_OUTPUT.put_line('V_DT_FECHAASIGNACION>>' || V_DT_FECHAASIGNACION);
...
/*****************************************************************
'* Nombre           :  SP_I_EXPEDIENTE_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Procedure que genera expediente de la multa en SIA
'*                     
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  Victor Bendezú
...
'****************************************************************/
  PROCEDURE SP_I_EXPEDIENTE_SICOB_A_SIA(PIN_NU_ID_MULTA   IN NUMBER,
    ...
    V_REG_T_SCOB_EST_EXP_COB_MOT    USR_SICOB.T_SCOB_EST_EXP_COB_MOTIVO%ROWTYPE;
  ...
  BEGIN
    ...
    BEGIN
      ...
      SELECT EXCM.*
        INTO V_REG_T_SCOB_EST_EXP_COB_MOT
    ...
    V_DT_COBEXPEDIENTEFECHA := V_REG_T_SCOB_EXPEDIENTE.FEC_INGRESO;       
    V_DT_COBFECHAULTIMO := V_REG_T_SCOB_EXPEDIENTE.FEC_ESTADO_EXPEDIENTE;
    ...
    V_VC_CODMOTIVOMULTA := V_REG_T_SCOB_EST_EXP_COB_MOT.CODIGO;
    V_VC_COBEXPEDIENTEESTADO := V_REG_T_SCOB_EST_EXP_COB.CODIGO;
    V_VC_COBEXPEDIENTEMOTIVO := V_REG_T_SCOB_EST_EXP_COB_MOT.CODIGO;
    ...
    UPDATE SGCORESYS.CO_MULTA SET 
      ...
      COBEXPEDIENTEFECHA = V_DT_COBEXPEDIENTEFECHA,
      COBFECHAULTIMO = V_DT_COBFECHAULTIMO,
    ...
    V_VC_ME_CODIGOMOTIVOEXPEDIENTE := V_REG_T_SCOB_EST_EXP_COB_MOT.CODIGO;
...
/*****************************************************************
'* Nombre           :  SP_U_MARCAR_MULTA_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Procedure que marca la multa en SIA por el File
'*                     
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  Victor Bendezú
...
/*****************************************************************
'* Nombre           :  SP_I_ARCH_CENTRAL_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Procedure que envia el archivo Central migrado al SIA
'*                     
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  Victor Bendezú
...
'****************************************************************/
  ...
  BEGIN
    ...
    V_VC_IDENTIFICADOR := V_REG_T_SCOB_MULTA.ANIO || V_REG_T_SCOB_MULTA.CUM;   
    V_DT_ENVIOFECHA := V_REG_T_SCOB_ARCHIVO_CENTRAL.FEC_ENVIO;
...
/*****************************************************************
'* Nombre           :  SP_I_CRONOGRAMA_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Procedure que genera Cronograma de Pago al SIA
'*                     
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  Victor Bendezú
...
'****************************************************************/
  PROCEDURE SP_I_CRONOGRAMA_SICOB_A_SIA(PIN_NU_ID_MULTA                IN NUMBER,    
    ...
    V_REG_T_SCOB_EXPED_CRONO_DET  USR_SICOB.T_SCOB_EXPED_CRONOGRAMA_DET%ROWTYPE;      
    V_REG_T_SCOB_MULTA                 USR_SICOB.T_SCOB_MULTA%ROWTYPE;  
    V_REG_T_SCOB_EXPEDIENTE            USR_SICOB.T_SCOB_EXPEDIENTE%ROWTYPE;
    
    V_VC_IDENTIFICADOR                 SGCORESYS.CO_MULTACUOTA.IDENTIFICADOR%TYPE;
    V_NU_CUOTA                         SGCORESYS.CO_MULTACUOTA.CUOTA%TYPE;
    V_DT_FECHAVENCIMIENTO              SGCORESYS.CO_MULTACUOTA.FECHAVENCIMIENTO%TYPE;
    ...
    V_DT_FECHAAPROBACIONCUOTA          SGCORESYS.CO_MULTACUOTA.FECHAAPROBACIONCUOTA%TYPE;
  ...
  BEGIN
    ...
    OPEN CURSOR_CUOTAS_CRONOGRAMA(PIN_NU_ID_MULTA);
      ...
      LOOP 
        ...
        FETCH CURSOR_CUOTAS_CRONOGRAMA INTO V_REG_T_SCOB_EXPED_CRONO_DET;
           
        EXIT WHEN CURSOR_CUOTAS_CRONOGRAMA%NOTFOUND;    
        
        V_VC_IDENTIFICADOR := V_REG_T_SCOB_MULTA.ANIO || V_REG_T_SCOB_MULTA.CUM;
        V_NU_CUOTA := V_REG_T_SCOB_EXPED_CRONO_DET.NRO_CUOTA;
        V_DT_FECHAVENCIMIENTO := V_REG_T_SCOB_EXPED_CRONO_DET.FEC_VENCIMIENTO;
        V_NU_CAPITAL := V_REG_T_SCOB_EXPED_CRONO_DET.MONTO_DEUDA_AMORTIZA_CRONO;
        V_NU_INTERESES := V_REG_T_SCOB_EXPED_CRONO_DET.MONTO_INTERES;
        V_NU_IMPORTE := V_REG_T_SCOB_EXPED_CRONO_DET.MONTO_TOTAL_DEUDA;
        V_NU_GASTOS := V_REG_T_SCOB_EXPED_CRONO_DET.MONTO_COSTAS;
        V_NU_MORA := V_REG_T_SCOB_EXPED_CRONO_DET.MONTO_INTERES_MORATORIO;
        V_NU_TOTAL := V_REG_T_SCOB_EXPED_CRONO_DET.MONTO_TOTAL_DEUDA;
        V_NU_AMORTIZADOMONTO := V_REG_T_SCOB_EXPED_CRONO_DET.TOTAL_AMORTIZADO_DEUDA;
        V_NU_AMORTIZADOCAPITAL := V_REG_T_SCOB_EXPED_CRONO_DET.TOTAL_AMORTIZADO;
        V_NU_SALDOCUOTA := V_REG_T_SCOB_EXPED_CRONO_DET.SALDO_TOTAL_DEUDA;
        V_NU_SALDOCAPITAL := V_REG_T_SCOB_EXPED_CRONO_DET.SALDO;
        V_DT_FECHAAPROBACIONCUOTA := TRUNC(V_REG_T_SCOB_EXPEDIENTE.FEC_ESTADO_EXPEDIENTE);
        ...
        V_NU_SALDOINTERES := V_REG_T_SCOB_EXPED_CRONO_DET.SALDO_IC;
        V_NU_SALDOMORA := V_REG_T_SCOB_EXPED_CRONO_DET.SALDO_IM;
        V_NU_SALDOCOSTAS := V_REG_T_SCOB_EXPED_CRONO_DET.SALDO_COSTAS;
        V_NU_AMORTIZADOINTERES := V_REG_T_SCOB_EXPED_CRONO_DET.TOTAL_AMORTIZADO_IC;
        V_NU_AMORTIZADOMORA := V_REG_T_SCOB_EXPED_CRONO_DET.TOTAL_AMORTIZADO_IM;
        V_NU_AMORTIZADOCOSTA := V_REG_T_SCOB_EXPED_CRONO_DET.TOTAL_AMORTIZADO_COSTAS;
...
/*****************************************************************
'* Nombre           :  SP_I_COACTIVO_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Procedure que proceso coactivo al SIA
'*                     
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  Victor Bendezú
...
/*****************************************************************
'* Nombre           :  SP_D_MULTA_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Método para eliminar la multa del SIA, previamente se valido
'*                     en el SICOB que sea solo los estados de Impuesta
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  jjimenez
'* Fec Creación     :  2023-02-03 18:06:00
'* Fec Actualización:  
'****************************************************************/
  PROCEDURE SP_D_MULTA_SICOB_A_SIA(PIN_NU_ID_MULTA      IN NUMBER,
                                   POUT_NU_COD_RESULT   OUT NUMBER,
    ...
    V_NU_ID_MULTA_DETAL           USR_SICOB.T_SCOB_MULTA_DETAL.ID_MULTA_DETAL%TYPE;
    V_VC_IDENTIFICADOR            SGCORESYS.CO_MULTA.IDENTIFICADOR%TYPE;
  ...
  BEGIN
   ...
   BEGIN
      ...
      SELECT MULTA.ANIO || MULTA.CUM
        INTO V_VC_IDENTIFICADOR
        FROM USR_SICOB.T_SCOB_MULTA MULTA
       WHERE MULTA.ID_MULTA = PIN_NU_ID_MULTA;
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE EX_CONTROLADO;
      WHEN OTHERS THEN
        POUT_VC_MSG_RESULT := 'NO CONFORME : SP_REGISTRO_MULTA_SICOB_A_SIA - CONSULTA T_SCOB_MULTA - ERROR : ' ||
                          SQLERRM;
        RAISE EX_CONTROLADO;
    END;
    ...
    BEGIN
      ...
      SELECT MULTA_DETALLE.ID_MULTA_DETAL
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE EX_CONTROLADO;
      WHEN OTHERS THEN
        POUT_VC_MSG_RESULT := 'NO CONFORME : SP_REGISTRO_MULTA_SICOB_A_SIA - CONSULTA T_SCOB_MULTA_DETAL - ERROR : ' ||
                          SQLERRM;
        RAISE EX_CONTROLADO;
    END;
       
    DELETE SGCORESYS.CO_MULTAESTADO WHERE IDENTIFICADOR = V_VC_IDENTIFICADOR;
    DELETE SGCORESYS.CO_MULTA WHERE IDENTIFICADOR = V_VC_IDENTIFICADOR;
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      POUT_NU_COD_RESULT := -1;
      POUT_VC_MSG_RESULT := 'ERROR NO CONTROLADO : SP_D_MULTA_SICOB_A_SIA - ERROR : ' ||
                        SQLERRM;
  END SP_D_MULTA_SICOB_A_SIA;
  
/*****************************************************************
'* Nombre           :  SP_U_EXPEDIENTE_CERO_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB
'* Propósito        :  Método para actualizar los datos del expediente
'*                     coactivo cuando se aplica multa cero al SIA
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  jjimenez
'* Fec Creación     :  2023-02-05 18:06:00
'* Fec Actualización:  
'****************************************************************/ 
PROCEDURE SP_U_EXPEDIENTE_CERO_A_SIA(PIN_NU_ID_MULTA   IN NUMBER,
                                     POUT_NU_COD_RESULT OUT NUMBER,
    ...
    V_VC_COBEXPEDIENTEESTADO_SIA        SGCORESYS.CO_MULTA.COBEXPEDIENTEESTADO%TYPE;
    V_VC_COBEXPEDIENTEESTADO            SGCORESYS.CO_MULTA.COBEXPEDIENTEESTADO%TYPE;
    V_VC_COBEXPEDIENTEMOTIVO            SGCORESYS.CO_MULTA.COBEXPEDIENTEMOTIVO%TYPE;
    V_DT_COBFECHAULTIMO                 SGCORESYS.CO_MULTA.COBFECHAULTIMO%TYPE;
    
    V_VC_ME_ESTADOMULTA                 SGCORESYS.CO_MULTA.ESTADOMULTA%TYPE;
    V_VC_ME_ESTADOPAGO                  SGCORESYS.CO_MULTA.ESTADOPAGO%TYPE;
    V_VC_ME_ESTADOCOBRANZA              SGCORESYS.CO_MULTA.ESTADOMULTACOBRANZA%TYPE;
    V_NU_ME_CAPITAL_ANT                 SGCORESYS.CO_MULTAESTADO.CAPITAL_ANT%TYPE;
    V_NU_ME_INTERESES_ANT               SGCORESYS.CO_MULTAESTADO.INTERESES_ANT%TYPE;
    V_NU_ME_MORA_ANT                    SGCORESYS.CO_MULTAESTADO.MORA_ANT%TYPE;
    V_NU_ME_GASTOS_ANT                  SGCORESYS.CO_MULTAESTADO.GASTOS_ANT%TYPE;
  ...
  BEGIN
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE EX_CONTROLADO;
      WHEN OTHERS THEN
        POUT_VC_MSG_RESULT := 'NO CONFORME : SP_U_EXPEDIENTE_CERO_A_SIA - CONSULTA T_SCOB_MULTA - ERROR : ' ||
                          SQLERRM;
        RAISE EX_CONTROLADO;
    END;
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE EX_CONTROLADO;
      WHEN OTHERS THEN
        POUT_VC_MSG_RESULT := 'NO CONFORME : SP_U_EXPEDIENTE_CERO_A_SIA - CONSULTA T_SCOB_MULTA_DETAL - ERROR : ' ||
                          SQLERRM;
        RAISE EX_CONTROLADO;
    END;
    ...
    BEGIN
      ...
      SELECT EXPE.* INTO V_REG_T_SCOB_EXPEDIENTE
         FROM USR_SICOB.T_SCOB_EXPEDIENTE_MULTA EXMU
        INNER JOIN USR_SICOB.T_SCOB_EXPEDIENTE EXPE
          ON EXPE.ID_EXPEDIENTE = EXMU.ID_EXPEDIENTE
         AND EXPE.ESTADO = '1'
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE EX_CONTROLADO;
      WHEN OTHERS THEN
        POUT_VC_MSG_RESULT := 'NO CONFORME : SP_U_EXPEDIENTE_CERO_A_SIA - CONSULTA T_SCOB_EXPEDIENTE - ERROR : ' ||
                          SQLERRM;
        RAISE EX_CONTROLADO;
    END;
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE EX_CONTROLADO;
      WHEN OTHERS THEN
        POUT_VC_MSG_RESULT := 'NO CONFORME : SP_REGISTRO_MULTA_SICOB_A_SIA - CONSULTA T_SCOB_ORGANO_RESOLUTIVO - ERROR : ' ||
                          SQLERRM;
        RAISE EX_CONTROLADO;
    END;
    ...
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        ...
        RAISE EX_CONTROLADO;
      WHEN OTHERS THEN
        POUT_VC_MSG_RESULT := 'NO CONFORME : SP_REGISTRO_MULTA_SICOB_A_SIA - CONSULTA T_SCOB_EST_EXP_COB_MOTIVO - ERROR : ' ||
                          SQLERRM;
        RAISE EX_CONTROLADO;
    END;
    ...
    V_VC_IDENTIFICADOR := V_REG_T_SCOB_MULTA.ANIO || V_REG_T_SCOB_MULTA.CUM; 
    V_VC_COBEXPEDIENTEESTADO := V_REG_T_SCOB_EXPEDIENTE.ESTADO_EXPEDIENTE;
    V_VC_COBEXPEDIENTEMOTIVO := V_REG_T_SCOB_EST_EXP_COB_MOT.CODIGO;   
    V_NU_UITNRO := NVL(V_REG_T_SCOB_MULTA_DETAL.VALOR_UIT, 0);
    V_NU_UITMONTOCAPITAL := V_REG_T_SCOB_MULTA.MONTO_UIT;
    V_NU_INTERESES := V_REG_T_SCOB_MULTA.MONTO_INTERES;
    ...
    -- SE SACA EL ESTADO DEL EXPEDIENTE DEL SIA 
    SELECT COBEXPEDIENTEESTADO INTO V_VC_COBEXPEDIENTEESTADO_SIA
      FROM SGCORESYS.CO_MULTA
      WHERE IDENTIFICADOR = V_VC_IDENTIFICADOR;
    ...
    IF V_VC_COBEXPEDIENTEESTADO_SIA <> V_VC_COBEXPEDIENTEESTADO THEN 
        V_NU_ME_SECUENCIA := V_NU_SECUENCIA_ACTUAL + 1;
        V_VC_ME_ESTADOMULTA := V_REG_T_SCOB_MULTA_DETAL.ESTADO_MULTA;
        V_VC_ME_ESTADOPAGO := V_REG_T_SCOB_MULTA.FLG_TIPO_MULTA;
        V_VC_ME_ESTADOCOBRANZA := V_REG_T_SCOB_MULTA.ESTADO_MULTA;
        V_NU_ME_CAPITAL_ANT := V_REG_T_SCOB_MULTA.MONTO_UIT;
        V_NU_ME_INTERESES_ANT := V_REG_T_SCOB_MULTA.MONTO_INTERES;
        V_NU_ME_MORA_ANT := V_REG_T_SCOB_MULTA.MONTO_INTERES_MORATORIO;
        V_NU_ME_GASTOS_ANT := V_REG_T_SCOB_MULTA.MONTO_COSTAS;
    ...
    ELSE
       V_NU_ME_SECUENCIA := V_NU_SECUENCIA_ACTUAL;
       UPDATE SGCORESYS.CO_MULTAESTADO SET        
        ESTADOEXPEDIENTE = V_VC_COBEXPEDIENTEESTADO,        
        CODIGOMOTIVOEXPEDIENTE = V_VC_COBEXPEDIENTEMOTIVO,
        GASTOS = V_NU_GASTOS,
        GASTOS_ANT = V_NU_ME_GASTOS_ANT,
        SALDOGASTOS = V_NU_SALDOGASTOS,
        CAPITAL = V_NU_UITMONTOCAPITAL,
        CAPITAL_ANT = V_NU_ME_CAPITAL_ANT,
        SALDOCAPITAL = V_NU_SALDO     
      WHERE 
        IDENTIFICADOR = V_VC_IDENTIFICADOR
        AND SECUENCIA = V_NU_ME_SECUENCIA;    
    END IF;
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      POUT_NU_COD_RESULT := -1;
      POUT_VC_MSG_RESULT := 'ERROR NO CONTROLADO : SP_U_EXPEDIENTE_CERO_A_SIA - ERROR : ' ||
                        SQLERRM;
  END SP_U_EXPEDIENTE_CERO_A_SIA;
  
  
/*****************************************************************
'* Nombre           :  SP_U_EXPEDIENTE_SICOB_A_SIA
'* Parámetros       :  PIN_NU_ID_MULTA: Llave de la multa del SICOB, de tratarse un
'*                     expediente acumulado esta llave contendra la multa mas antigua
'* Propósito        :  Procedure que actualiza los datos de la multa, expediente y
'*                     montos de la multa en SIA
'* Output           :  POUT_NU_COD_RESULT : Codigo 0: Grabo OK
'*                     POUT_VC_MSG_RESULT : Mensaje del error
'* Creado por       :  jjimenez
'* Fec Creación     :  2023-02-10  18:06:00
'* Fec Actualización:  
'****************************************************************/
  PROCEDURE SP_U_EXPEDIENTE_SICOB_A_SIA(PIN_NU_ID_MULTA   IN NUMBER,
                                        POUT_NU_COD_RESULT OUT NUMBER,
    ...
    -- ESTADOS DE MULTA, PRECOACTIVO Y EXPEDIENTE COACTIVO
    V_VC_ME_IDENTIFICADOR                 SGCORESYS.CO_MULTAESTADO.IDENTIFICADOR%TYPE;
    V_NU_ME_SECUENCIA                     SGCORESYS.CO_MULTAESTADO.SECUENCIA%TYPE;
    V_VC_ME_ESTADOMULTA                   SGCORESYS.CO_MULTAESTADO.ESTADOMULTA%TYPE;
    V_VC_ME_ESTADOPAGO                    SGCORESYS.CO_MULTAESTADO.ESTADOPAGO%TYPE;
  ...
  BEGIN
    ...
    V_VC_ME_CUENTAPROVISION := NULL;
    -- OTROS
    V_VC_ESTADOPAGO := V_REG_T_SCOB_MULTA.COD_ESTADO_PAGO;
  ...
  WHERE   
    ...
    -- SE SACA EL ESTADO DEL EXPEDIENTE DEL SIA 
    SELECT COBEXPEDIENTEESTADO INTO V_VC_ESTADOMULTA_SIA
      FROM SGCORESYS.CO_MULTA
      WHERE IDENTIFICADOR = V_VC_IDENTIFICADOR;
    ...
    --EN CASO EL ESTADO CAMBIA SE HACE UN NUEVO REGISTRO EN ESTADO_MULTA
    IF V_VC_ESTADOMULTA_SIA <> V_VC_COBEXPEDIENTEESTADO THEN        
       V_NU_ME_SECUENCIA := V_NU_SECUENCIA_ACTUAL + 1;
       INSERT INTO SGCORESYS.CO_MULTAESTADO(
        IDENTIFICADOR,
        SECUENCIA,
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      POUT_NU_COD_RESULT := -1;
      POUT_VC_MSG_RESULT := 'ERROR NO CONTROLADO : SP_U_EXPEDIENTE_SICOB_A_SIA - ERROR : ' ||
                        SQLERRM;
  END SP_U_EXPEDIENTE_SICOB_A_SIA;
