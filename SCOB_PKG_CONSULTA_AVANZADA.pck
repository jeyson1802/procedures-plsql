CREATE OR REPLACE PACKAGE SCOB_PKG_CONSULTA_AVANZADA IS
...
END SCOB_PKG_CONSULTA_AVANZADA;
/
CREATE OR REPLACE PACKAGE BODY SCOB_PKG_CONSULTA_AVANZADA IS
  ...
  BEGIN
    ...
    INSERT INTO USR_SICOB.T_SCOB_TMP_INSTANCIAS_MULTA1
      ...
      (SELECT MDET.ID_MULTA,
              ...
              TO_DATE(TO_CHAR(MDET.AUDFECCREACION, 'DD/MM/YYYY'),
                      'DD/MM/YYYY'),
              MDET.AUDUSUCREACION,
    ...
    V_SQL_SELECT_2 := '--SEGUNDA INSTANCIA
